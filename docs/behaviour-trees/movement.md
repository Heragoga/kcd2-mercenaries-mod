...
If you haven't read [basic-structure](basic-structure.md) I highly recommend you do so now, as this guide only presents a few nodes and the surrounding details that enable movement.
