...
This guide assumes you've already set up the workflow from the [Custom Equipment Presets](adding-new-outfits.md) guide (repo cloned, `PackageMod.bat` working). If not, follow steps 1 and 2 there first.
