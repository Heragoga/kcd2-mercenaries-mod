...
| # | Encounter | Status |
|---|-----------|--------|
| 1 | **Camp raids** - a hostile band marches on the camp while the player is in it | **done** - `mercenaries_raids.lua`, see [walls-and-sieges.md](walls-and-sieges.md) ("Scheduled raids") |
