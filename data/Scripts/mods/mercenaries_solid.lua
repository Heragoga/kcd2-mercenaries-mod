...
-- The static physics table this mod uses everywhere, or nil to spawn with no physics.
function mercenaries:PropPhysics(kind)
    if not self:PropSolid(kind) then return nil end
...
function mercenaries:SolidSweep()
    ...
    local freed, asked, pressing, held = 0, 0, 0, 0
