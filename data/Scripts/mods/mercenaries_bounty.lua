...
System.AddCCommand("merc_bounty_start",   "mercenaries:BountyAccept()",  "Take a bandit-camp bounty (same as the quartermaster dialog)")
System.AddCCommand("merc_bounty_status",  "mercenaries:BountyStatus()",  "Bounty state: site, group, kills, reward")
System.AddCCommand("merc_bounty_report",  "mercenaries:BountyReport()",  "Report the bounty in and collect (debug)")
System.AddCCommand("merc_bounty_clear",   "mercenaries:BountyForceClear()", "Force-complete the bounty camp (debug)")
System.AddCCommand("merc_bounty_abandon", "mercenaries:BountyAbandon()", "Drop the bounty and remove its camp")
System.AddCCommand("merc_bounty_reset",   "mercenaries:SaveString('BountyDone','0')", "Zero the paid-bounty counter (debug)")
