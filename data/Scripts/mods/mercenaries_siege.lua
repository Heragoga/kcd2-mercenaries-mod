...
function mercenaries:SiegeBinds(quiet)
    ...
    -- Building means placing both sides within sight of each other, so they hold fire until
    -- merc_siege_go says otherwise.
    self.SiegePeace = true
    pcall(function()
...
System.AddCCommand("merc_siege_defenders",  "mercenaries:SiegePick(1)", "F5 - defenders")
System.AddCCommand("merc_siege_attackers",  "mercenaries:SiegePick(2)", "F6 - attackers")
System.AddCCommand("merc_siege_barricades", "mercenaries:SiegePick(3)", "F7 - barricades")
System.AddCCommand("merc_siege_tents",      "mercenaries:SiegePick(4)", "F8 - tents and the camp circle")
System.AddCCommand("merc_siege_props",      "mercenaries:SiegePick(5)", "F9 - props and furniture")
System.AddCCommand("merc_siege_stations",   "mercenaries:SiegePick(6)", "F10 - carts, taverns, towers")
System.AddCCommand("merc_siege_dump",       "mercenaries:SiegeDump()",  "F11 - print the layout")
System.AddCCommand("merc_siege_tents_gallery", "mercenaries:SiegeTentGallery(%line)", "Lay out every candidate tent mesh in a row: whatever renders exists")
System.AddCCommand("merc_siege_tents_clear",   "mercenaries:SiegeTentGalleryClear()", "Remove the tent gallery")
System.AddCCommand("merc_siege_go",        "mercenaries:SiegeGo()",   "Let the placed men fight (peace off)")
System.AddCCommand("merc_siege_hold",      "mercenaries:SiegeHold()", "Make everyone hold fire again (peace on)")
System.AddCCommand("merc_siege_patrol",     "mercenaries:SiegePatrolNew()", "Start a NEW patrol route; waypoints placed after this join it")
System.AddCCommand("merc_siege_new",        "mercenaries:SiegeNew()",   "Clear the site and start over")
System.AddCCommand("merc_siege_place",      "mercenaries:SiegePlace()", "Place at your aim point (console alternative to left-click)")
System.AddCCommand("merc_siege_undo",       "mercenaries:SiegeUndo()",  "Take back the last piece")
System.AddCCommand("merc_siege_group",      "mercenaries:SiegeGroup(%line)", "Who the attackers are: merc_siege_group sigi|bandit|looter|knight|cuman|prague")
System.AddCCommand("merc_siege_try",        "mercenaries:SiegeTry(%line)", "Drop any .cgf at your aim point to see if it exists: merc_siege_try <path>")
System.AddCCommand("merc_siege_list",       "mercenaries:SiegeList()",  "List the current category")
System.AddCCommand("merc_siege_help",       "mercenaries:SiegeHelp()",  "Key map and commands")
System.AddCCommand("merc_siege_off",        "mercenaries:SiegeStop()",  "Leave the editor")
System.AddCCommand("merc_siege_binds",      "mercenaries:SiegeBinds()", "Give F5-F11 to the siege builder")
