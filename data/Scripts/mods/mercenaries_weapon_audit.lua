...
System.AddCCommand("merc_wpn_audit",        "mercenaries:WeaponAuditSpawn()",                 "Spawn one NPC per mod weapon preset in a numbered grid and log who ended up unarmed")
System.AddCCommand("merc_wpn_audit_enemy",  "mercenaries:WeaponAuditSpawn(1, nil, 'bandit')", "Same lineup on a bandit enemy soul (hostile) so it matches the reported bug exactly")
System.AddCCommand("merc_wpn_audit_p1",     "mercenaries:WeaponAuditSpawn(1, 24)",            "Lineup, presets 1-24 only")
System.AddCCommand("merc_wpn_audit_p2",     "mercenaries:WeaponAuditSpawn(25, 24)",           "Lineup, presets 25-48 only")
System.AddCCommand("merc_wpn_audit_p3",     "mercenaries:WeaponAuditSpawn(49, 24)",           "Lineup, presets 49-72 only")
System.AddCCommand("merc_wpn_audit_p4",     "mercenaries:WeaponAuditSpawn(73, 24)",           "Lineup, presets 73-96 only")
System.AddCCommand("merc_wpn_audit_p5",     "mercenaries:WeaponAuditSpawn(97, 25)",           "Lineup, presets 97-121 only")
System.AddCCommand("merc_wpn_audit_draw",   "mercenaries:WeaponAuditDraw()",                  "Make the whole lineup draw, so an empty hand means something is really wrong")
System.AddCCommand("merc_wpn_audit_who",    "mercenaries:WeaponAuditWho()",                   "Name the lineup NPC you are standing next to, and say whether his weapon landed")
System.AddCCommand("merc_wpn_audit_report", "mercenaries:WeaponAuditReport()",                "Re-check the standing lineup and log only the unarmed ones")
System.AddCCommand("merc_wpn_audit_clear",  "mercenaries:WeaponAuditClear()",                 "Despawn the lineup")
System.AddCCommand("merc_wpn_audit_static", "mercenaries:WeaponAuditStatic()",                "No spawning: list presets referencing an item_class_id that is in no item table")
