...
-- ...and the interact key places, crouch cancels, for the people whose right button never
-- reaches us - another mod holding the mouse, or a controller, where the A button is `use`.
mercenaries.TowerPlaceActions  = { attack_primary_mouse = true, use = true }
mercenaries.TowerCancelActions = { block = true, crouch = true, sneak = true }
...
mercenaries.TowerSwallowActions = { attack_primary_mouse = true, block = true, attack_abort = true,
                                    use = true, crouch = true, sneak = true }
