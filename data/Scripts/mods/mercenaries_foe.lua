...
mercenaries.FoeAlertRange  = 90.0    -- how far the shout carries to other foes
...
-- ON: a camp that is found is a camp that comes at you together. With chains off the men
-- beyond the first shout's reach trickled in one small group after another, and a player who
-- holds his ground killed them in detail ("they charge, but not together" - a streamer).
mercenaries.FoeAlertChains = true    -- true: a foe alerted BY a shout shouts on too
