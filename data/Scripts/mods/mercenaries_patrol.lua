...
System.AddCCommand("merc_patrol_wp",     "mercenaries:PatrolAddWaypoint()",  "Drop a patrol waypoint where you are looking")
System.AddCCommand("merc_patrol_wpclear","mercenaries:PatrolClearWaypoints()","Remove the patrol waypoints")
System.AddCCommand("merc_patrol_spawn",  "mercenaries:PatrolSpawn('%line')", "Spawn a patrol formed up ahead of you: merc_patrol_spawn [count] [group]")
System.AddCCommand("merc_patrol_go",     "mercenaries:PatrolGo()",           "Send the patrol walking the waypoints")
System.AddCCommand("merc_patrol_stop",   "mercenaries:PatrolStop()",         "Halt the patrol where it stands")
System.AddCCommand("merc_patrol_clear",  "mercenaries:PatrolClearAll()",     "Remove the patrol and its waypoints")
System.AddCCommand("merc_patrol_status", "mercenaries:PatrolStatus()",       "Where the patrol is and what it is doing")
