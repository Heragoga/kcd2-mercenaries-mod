...
function mercenaries:FoeEquip(ent)
    ...
    pcall(function() self:EquipMercenaryWeapon(ent, math.random(2, 9), nil) end)
...
System.AddCCommand("foe_spawn",       "mercenaries:FoeSpawn(8, 45, 20)",   "Spawn 8 unalerted foes 45m ahead")
System.AddCCommand("foe_spawn_1",     "mercenaries:FoeSpawn(1, 25, 0)",    "Spawn one unalerted foe 25m ahead")
System.AddCCommand("foe_spawn_20",    "mercenaries:FoeSpawn(20, 55, 40)",  "Spawn 20 unalerted foes 55m ahead")
System.AddCCommand("foe_spawn_scout", "mercenaries:FoeSpawnScouted()",     "Alert demo: a scout at 30m and a band at 75m")
System.AddCCommand("foe_clear",       "mercenaries:FoeClear()",            "Remove every foe")
System.AddCCommand("foe_status",      "mercenaries:FoeStatus()",           "Per-foe state, alert source and engage delay")
System.AddCCommand("foe_alert",       "mercenaries:FoeAlertAll()",         "Alert every foe now (debug)")
System.AddCCommand("foe_calm",        "mercenaries:FoeCalm()",             "Send every foe back to idle (debug)")
System.AddCCommand("foe_ranges",      "mercenaries:FoeSetRanges('%line')", "foe_ranges <detectM> <shoutM>")
System.AddCCommand("foe_auto",        "mercenaries:FoeSetAutomation('%line')", "foe_auto <offense|defense|guard|weapon|movement> <0|1>; no args lists them")
