...
mercenaries.AlxBeats = {
    ...
    [9] = { name = "the marsh island",  site = "swamp_island",   group = "ruthenian",
            ...
            leaderGear = mercenaries.AlxKnightHarness,
            -- He needs this SPELLED OUT: leaderGear strips him to the skin first, so without a
            -- weapon preset of his own he met the player bare-handed. Axe and shield, like his men
...
function mercenaries:AlxSpawnLeaderNPC(pos, yaw, beat)
    ...
    if beat.leaderGear then
        -- STRIP HIM FIRST. EquipEnemy above has already put the group's livery on him, and the
        -- harness went on over the top of it - two sets of clothes at once, Sigismund's showing
        -- through the plate. RemoveAllItems clears the lot; then the slots are empty for the
        -- layering below.
